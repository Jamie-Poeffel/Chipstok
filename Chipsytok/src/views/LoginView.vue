  ...
  <div
    ...
    <div class="w-96 p-8 pb-2 bg-white border border-gray-300 rounded-xl shadow-lg text-center relative z-10">
      ...
      <button type="button" class="button mt-2">
        <a
          :href="`https://api.chipslyfans.bbzwinf.ch/auth/oauth/authorize?client_id=${generateCharString(new Date())}&redirect_uri=https://api.chipsytok.bbzwinf.ch/oauth/callback&response_type=code`">
